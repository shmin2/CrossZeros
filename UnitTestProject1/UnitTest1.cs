...
namespace UnitTestProject1
{
    ...
    public class UnitTest1
    {
        ...
        public void RowPositive()
        {
            ...
            Assert.IsTrue(ConsoleApp2.Engine.CheckFieldForWin(fild, 0, 0));
        }
        ...
        public void RowNegative()
        {
            ...
            Assert.IsTrue(ConsoleApp2.Engine.CheckFieldForWin(fild, 0, 1));
        }
        ...
        public void ColumnPositive2()
        {
            ...
            Assert.IsTrue(ConsoleApp2.Engine.CheckFieldForWin(fild, 1, 1));
        }
        ...
        public void ColumnNegative()
        {
            ...
            Assert.IsFalse(ConsoleApp2.Engine.CheckFieldForWin(fild, 1, 1));
        }
        ...
        {
            Field fild = new Field(new[,] { { 'O', 'X', 'O' }, { 'X', 'O', 'O' }, { 'X', 'X', 'O' } });
            Assert.IsFalse(ConsoleApp2.Engine.CheckFieldForWin(fild, 0, 1));
        }
    }
}
